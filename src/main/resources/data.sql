...
INSERT INTO libitem(item_type, title, creator, description, genre, publication_year, available) VALUES('Ebook', 'Harry Potter', 'JK Rowling', 'Harry yer a wizard', 'Fantasy', 1999, 'true');
